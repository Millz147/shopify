				    ...
				    <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"  data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
				        ...
				        <div class="container">            
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
				                            <li class="single-cart-list">
				                                ...
				                                <div class="cart-list-txt">
				                                	...
				                                	<p>1 x - <span class="price">N180.00</span></p>
				                                </div>
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="index.html">Yoo<span>dule</span>.</a>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								...
								<div class="single-populer-products-para">
									<p>A good product from Yoodule</p>
								</div>
							</div>
						</div>
...
if (in_array($permext, $validExt)){
move_uploaded_file($fileLoc, $destination);
$str = file_get_contents($destination);
$base64 = base64_encode($str);

$src = 'data:'.mime_content_type($destination).';charset=utf-8'.';base64,'.$base64;

echo '<img src="'.$src.'" alt= "Uploaded Image Will Show here">';
										...
										<div class="col-md-8 col-sm-12">
											<div class="single-inner-populer-product-txt">
												<h2>
														...
														Upload an Image File <span>Here</span> 
...
<div class="input-group">
	...
	<input type="submit" name = "submit" class="btn-cart welcome-add-cart populer-products-btn"/>
</form>



<p> As requested by Yoodule </p>
					...
					<div class="row">
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N65.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N80.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N40.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N100.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N120.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N140.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<p class="arrival-product-price">N90.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
		...
		<footer id="footer"  class="footer">
			<div class="container">
				<div class="hm-footer-copyright text-center">
					...
					<p>
						&copy;copyright. designed and developed by <a href="https://linkedin.com/in/ibrahim-habib-30a9a070/">Ibrahim Habib</a>
					</p>
				</div>
			</div>
